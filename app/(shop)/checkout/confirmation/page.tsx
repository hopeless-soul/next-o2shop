  ...
  if (!orderNumber || error) {
    return (
      <div className="py-16 text-center">
        <p className="font-sans text-[13px] mb-4 text-foreground-muted">
  ...
  return (
    <div className="w-full max-w-2xl py-10">
      ...
      <div className="flex items-center gap-3 mb-8">
        <CheckCircle size={32} className="text-foreground-dark" />
        <div>
          <h1 className="font-sans text-[28px] uppercase tracking-widest leading-none text-foreground-dark">
            Order Confirmed
          </h1>
          {order && (
            <p className="text-sm mt-1 font-secondary text-foreground-muted">
              #{order.orderNumber}
            </p>
          )}
        </div>
        ...
        <>
          ...
          <div className="flex flex-col gap-3 mb-8">
            {order.items.map((item) => (
              <div
                key={item.id}
                className="flex justify-between border-b pb-3 border-border-light"
              >
                <div>
          ...
          <div className="mb-10 flex flex-col gap-1.5 max-w-xs ml-auto">
            ...
            <div className="flex justify-between border-t pt-2 border-border">
              <span className="font-sans text-[13px] uppercase tracking-widest text-foreground-dark">
                Total
              </span>
              <span className="font-sans text-[16px] text-foreground-dark">
